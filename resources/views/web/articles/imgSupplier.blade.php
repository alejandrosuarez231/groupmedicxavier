...
<div class="col-md-6 col-md-offset-3">
	{!! Form::open(['route' => ['web.supplier.img.store', $supplier->id], 'enctype' => 'multipart/form-data']) !!}
	...
	@if ($supplier->img <> null)
		<div class="thumbnail no-border-radius">
			<div class="thumb">
				<img src="http://scinformatica.cl/site/public/{{ $supplier->img }}" alt="">
				<div class="caption-overflow">
					<span>
						{!! Form::open(['route' => ['web.supplier.img.destroy', $supplier->id], 'method' => 'DELETE', 'class' => 'form-horizontal']) !!}
						<a href="http://scinformatica.cl/site/public/{{ $supplier->img }}" data-popup="lightbox" rel="gallery" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-plus3"></i></a>
